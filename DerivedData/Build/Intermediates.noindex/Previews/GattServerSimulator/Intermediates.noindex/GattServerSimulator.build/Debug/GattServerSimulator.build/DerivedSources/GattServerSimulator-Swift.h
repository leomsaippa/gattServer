...
#ifndef GATTSERVERSIMULATOR_SWIFT_H
#define GATTSERVERSIMULATOR_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="GattServerSimulator",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif


SWIFT_CLASS("_TtC19GattServerSimulator17AdapterGattServer")
@interface AdapterGattServer : NSObject
...
@interface AdapterGattServer (SWIFT_EXTENSION(GattServerSimulator)) <CBPeripheralManagerDelegate>
...
SWIFT_CLASS("_TtC19GattServerSimulator11AppDelegate")
...
typedef SWIFT_ENUM_NAMED(NSInteger, MJLogLevel, "LogLevel", closed) {
  MJLogLevelTrace = 0,
  MJLogLevelDebug = 1,
  MJLogLevelInfo = 2,
  MJLogLevelWarning = 3,
...
///
/// \param tag An additional label to help categorise logs.
///
/// \param message The message to be logged.
///
- (void)logWithLevel:(enum MJLogLevel)level tag:(NSString * _Nullable)tag message:(NSString * _Nonnull)message;
/// Logs a key-value pair
/// \param key They key
///
/// \param value The value
///
- (void)logWithKey:(NSString * _Nonnull)key value:(id _Nullable)value;
@end
